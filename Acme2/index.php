...
<html>
	...
	<body class="landing">
		<div id="page-wrapper">
			...
			<!-- Header -->
				<header id="header">
					<h1 id="logo"><a href="index.html">ACME</a></h1>
					<nav id="nav">
						<ul>
			...
			<!-- Banner -->
				<section id="banner">
					<div class="content">
						...
						<span class="image"><img src="images/first picture.jpg" alt="" /></span>
					</div>
  	...
  	<input type="text" placeholder="Search here..." required>
						...
						<ul class="actions">
							<li><a href="homepageemployee.php" class="button">Search Directory</a></li>
						</ul>
					</div>
