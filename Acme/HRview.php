...
<html>
	...
	<body class="landing">
		<div id="page-wrapper">
			...
			<!-- Banner / shows a quick basic search for an employee/-->
				<section id="banner">
					<div class="content">
			...
			<!-- One /Options for the Human Resourses and Admin employee/-->
					...
					<div class="container">
						...
						<div class="box alt">
							...
							<a href="Addemployee.php">	<section class="4u 6u(medium) 12u$(xsmall)">
									<img src="https://www.united.ac.in/campustour/img/placement.png" height="150" width="150" ></span><br></br>
